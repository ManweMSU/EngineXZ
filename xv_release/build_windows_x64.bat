...
mkdir xv_release\_build\windows_x64\xda.loc
...
copy /B xi_dasm\xda.ini xv_release\_build\windows_x64\xda.ini
...
copy /B xi_dasm\_build\windows_x64_release\xda.exe xv_release\_build\windows_x64\xda.exe
...
.\xv_release\_build\windows_x64\xv.exe xv_lib\canonicalis.xv -NOP xv_release\_build\windows_x64\xvcl
...
estrtab xi_dasm\locale\ru.txt :binary xv_release\_build\windows_x64\xda.loc\ru.ecst
estrtab xi_dasm\locale\en.txt :binary xv_release\_build\windows_x64\xda.loc\en.ecst