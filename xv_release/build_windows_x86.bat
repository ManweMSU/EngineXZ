...
ertbuild xi_dasm\xda.ertproj -Nar x86
...
mkdir xv_release\_build\windows_x86\xda.loc
...
copy /B xi_dasm\xda.ini xv_release\_build\windows_x86\xda.ini
...
copy /B xi_dasm\_build\windows_x86_release\xda.exe xv_release\_build\windows_x86\xda.exe
...
estrtab xi_dasm\locale\ru.txt :binary xv_release\_build\windows_x86\xda.loc\ru.ecst
estrtab xi_dasm\locale\en.txt :binary xv_release\_build\windows_x86\xda.loc\en.ecst