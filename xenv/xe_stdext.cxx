...
namespace Engine
{
	namespace XE
	{
		...
		public:
			...
			{
				if (routine_name == L"alloca_memoriam") return _mem_alloc;
				else if (routine_name == L"realloca_memoriam") return _mem_realloc;
				else if (routine_name == L"dimitte_memoriam") return _mem_release;
				else return 0;
			}
		...
		class SPU : public IAPIExtension
		{
			...
			{ try { return self = with; } catch (...) { error.error_code = 2; error.error_subcode = 0; } }
			static string & _assign_with_utf32(string & self, const uint32 * with, ErrorContext & error)
			{ try { return self = string(with, -1, Encoding::UTF32); } catch (...) { error.error_code = 2; error.error_subcode = 0; } }
			...
			{ try { return a + b; } catch (...) { error.error_code = 2; error.error_subcode = 0; } }
			...
			static int32 _to_int32(const string & self, ErrorContext & error)
			{
				...
				catch (InvalidFormatException &) { error.error_code = 4; error.error_subcode = 0; }
				catch (InvalidArgumentException &) { error.error_code = 3; error.error_subcode = 0; }
				catch (...) { error.error_code = 2; error.error_subcode = 0; }
			}
		...
		public:
			virtual void * ExposeRoutine(const string & routine_name) noexcept override
			{
				if (routine_name == L"spu_crea") return _init_string_with_string;
				else if (routine_name == L"spu_crea_utf32") return _init_string_with_utf32;
				else if (routine_name == L"spu_crea_int8") return _init_string_with_int8;
				else if (routine_name == L"spu_crea_nint8") return _init_string_with_uint8;
				else if (routine_name == L"spu_crea_int16") return _init_string_with_int16;
				else if (routine_name == L"spu_crea_nint16") return _init_string_with_uint16;
				else if (routine_name == L"spu_crea_int32") return _init_string_with_int32;
				else if (routine_name == L"spu_crea_nint32") return _init_string_with_uint32;
				else if (routine_name == L"spu_crea_int64") return _init_string_with_int64;
				else if (routine_name == L"spu_crea_nint64") return _init_string_with_uint64;
				else if (routine_name == L"spu_crea_intadl") return _init_string_with_intptr;
				else if (routine_name == L"spu_crea_nintadl") return _init_string_with_uintptr;
				else if (routine_name == L"spu_crea_nint32_radix") return _init_string_with_uint32_radix;
				else if (routine_name == L"spu_crea_nint64_radix") return _init_string_with_uint64_radix;
				else if (routine_name == L"spu_crea_nintadl_radix") return _init_string_with_uintptr_radix;
				else if (routine_name == L"spu_crea_frac32") return _init_string_with_float;
				else if (routine_name == L"spu_crea_frac32_2") return _init_string_with_float_del;
				else if (routine_name == L"spu_crea_frac32_3") return _init_string_with_float_del_len;
				else if (routine_name == L"spu_crea_frac64") return _init_string_with_double;
				else if (routine_name == L"spu_crea_frac64_2") return _init_string_with_double_del;
				else if (routine_name == L"spu_crea_frac64_3") return _init_string_with_double_del_len;
				else if (routine_name == L"spu_crea_logicum") return _init_string_with_boolean;
				else if (routine_name == L"spu_crea_char") return _init_string_with_char;
				else if (routine_name == L"spu_crea_adl") return _init_string_with_ptr;
				else if (routine_name == L"spu_crea_data") return _init_string_with_data;
				else if (routine_name == L"spu_loca") return _assign_with_string;
				else if (routine_name == L"spu_loca_utf32") return _assign_with_utf32;
				else if (routine_name == L"spu_concat") return _concat;
				else if (routine_name == L"spu_concat_classis") return _static_concat;
				else if (routine_name == L"spu_compareo") return _static_order;
				else if (routine_name == L"spu_compareo_2") return _static_order_nc;
				else if (routine_name == L"spu_long") return _length;
				else if (routine_name == L"spu_index") return _subscript;
				else if (routine_name == L"spu_reperi_primus") return _find_first;
				else if (routine_name == L"spu_reperi_ultimus") return _find_last;
				else if (routine_name == L"spu_fragmentum") return _fragment;
				else if (routine_name == L"spu_surroga") return _replace;
				else if (routine_name == L"spu_inferna") return _lower_case;
				else if (routine_name == L"spu_supera") return _upper_case;
				else if (routine_name == L"spu_codex_long") return _encode_length;
				else if (routine_name == L"spu_codifica") return _encode;
				else if (routine_name == L"spu_ad_int32") return _to_int32;
				else if (routine_name == L"spu_ad_int32_2") return _to_int32_2;
				else if (routine_name == L"spu_ad_int32_3") return _to_int32_3;
				else if (routine_name == L"spu_ad_nint32") return _to_uint32;
				else if (routine_name == L"spu_ad_nint32_2") return _to_uint32_2;
				else if (routine_name == L"spu_ad_nint32_3") return _to_uint32_3;
				else if (routine_name == L"spu_ad_int64") return _to_int64;
				else if (routine_name == L"spu_ad_int64_2") return _to_int64_2;
				else if (routine_name == L"spu_ad_int64_3") return _to_int64_3;
				else if (routine_name == L"spu_ad_nint64") return _to_uint64;
				else if (routine_name == L"spu_ad_nint64_2") return _to_uint64_2;
				else if (routine_name == L"spu_ad_nint64_3") return _to_uint64_3;
				else if (routine_name == L"spu_ad_frac32") return _to_float;
				else if (routine_name == L"spu_ad_frac32_2") return _to_float_2;
				else if (routine_name == L"spu_ad_frac64") return _to_double;
				else if (routine_name == L"spu_ad_frac64_2") return _to_double_2;
				else if (routine_name == L"spu_forma_0") return _format_0;
				else if (routine_name == L"spu_forma_1") return _format_1;
				else if (routine_name == L"spu_forma_2") return _format_2;
				else if (routine_name == L"spu_forma_3") return _format_3;
				else if (routine_name == L"spu_forma_4") return _format_4;
				else if (routine_name == L"spu_forma_5") return _format_5;
				else if (routine_name == L"spu_forma_6") return _format_6;
				else if (routine_name == L"spu_forma_7") return _format_7;
				else if (routine_name == L"spu_forma_8") return _format_8;
				else if (routine_name == L"spu_forma_9") return _format_9;
				else if (routine_name == L"spu_codifica_taleam") return _encode_block;
				else if (routine_name == L"spu_scinde") return _split;
				else return 0;
			}
			virtual void * ExposeInterface(const string & interface) noexcept override { return 0; }
		};
