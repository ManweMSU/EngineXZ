...
linker\_build\windows_x64_release\xncon test.xx -Nbmolx stub.exe win-x64 x64.exe lib 1 test.txt
linker\_build\windows_x64_release\xncon test.xx -Nbmolx stub.exe win-x86 x86.exe lib 1 test.txt