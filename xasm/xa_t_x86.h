	...
	namespace XA
	{
		namespace X86
		{
			...
			protected:
				...
				void encode_bswap(uint quant, Reg reg);
				...
				void encode_simd_or(Reg xmm_dest, Reg xmm_src);
				void encode_simd_or(Reg xmm_dest, Reg src_ptr, int src_offset);
				void encode_simd_and(Reg xmm_dest, Reg xmm_src);
				void encode_simd_and(Reg xmm_dest, Reg src_ptr, int src_offset);
				void encode_simd_not_and(Reg xmm_dest, Reg xmm_src);
				void encode_simd_not_and(Reg xmm_dest, Reg src_ptr, int src_offset);
				void encode_simd_int_add(uint quant, Reg xmm_dest, Reg xmm_src);
				void encode_simd_int_add(uint quant, Reg xmm_dest, Reg src_ptr, int src_offset);
				void encode_simd_extract(Reg xmm_dest_src_hi, Reg xmm_src_lo, uint bytes_rotate);
				void encode_simd_extract(Reg xmm_dest_src_hi, Reg src_lo_ptr, int src_offset, uint bytes_rotate);
