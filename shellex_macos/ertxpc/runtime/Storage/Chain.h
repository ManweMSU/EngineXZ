...
namespace Engine
{
	namespace Storage
	{
		...
		bool ChainCompress(Streaming::Stream * dest, Streaming::Stream * source, MethodChain chain, CompressionQuality quality, uint32 block_size = 0x100000);
		bool ChainDecompress(Streaming::Stream * dest, Streaming::Stream * source);
