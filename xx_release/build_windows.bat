...
xv_release\_build\windows_%XVC_ARCH%\xi xv_release\_build\com\http_servus.xo         -Nto win-%ARCH% xx_release\_build\windows_%ARCH%\xxcl\http_servus.xo
xv_release\_build\windows_%XVC_ARCH%\xi xv_release\_build\com\http_servus_limarum.xo -Nto win-%ARCH% xx_release\_build\windows_%ARCH%\xxcl\http_servus_limarum.xo
